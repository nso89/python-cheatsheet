- [Slicing Out the First `x` Elements](#slicing-out-the-first-x-elements)
...
```
#### <a name="slicing-out-the-first-x-elements"></a>Slicing the First `x` Elements:
```python
 print(friends[:4]) # Output: Anna
```
#### <a name="slicing-out-the-last-x-elements"></a>Slicing the Last `x` Elements:
```python
